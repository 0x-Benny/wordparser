...
public class WordparserTest
{
    public static void main(String[] args) throws IOException
    {
        ...
        NYTimesAdapter csv = new NYTimesAdapter("./src/assets/nytimes/");
        database.addAll(csv.fetchArticles());

        TreeMap<String, Integer> frequency = Wordparser.wordCount(Wordparser.filterWords(database, "./src/assets/utilities/english_stoplist_v1.txt"));
