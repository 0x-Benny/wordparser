...
public class SerializerDeserializerTest
{
  ...
  public void serializeWithEmptyArrayTest() throws Exception
  {
    ...
    assertEquals("++ERROR. Could not create database. All sources are unavailable." + System.lineSeparator(), err.toString());
  ...
  public void deserializeNonExistingDatabaseTest() throws Exception
  {
    ...
    assertEquals("++ERROR. Database not found. Please, run the \"download\" option first." + System.lineSeparator(), err.toString());
    assertEquals(1, status);
  }
